...
void Server::cleanChannel(int fd) {
    ...
    for (std::map<std::string, Channel>::iterator it = channels.begin(); it != channels.end(); ++it) {
        ...
        for (std::map<std::string, int>::iterator it2 = usersfdmap.begin(); it2 != usersfdmap.end(); ) {
            if (it2->second == fd) {
    ...
    for (std::map<std::string, Channel>::iterator it1 = channels.begin(); it1 != channels.end(); ++it1) {
        ...
        for (std::map<std::string, int>::iterator it2 = invitedusrmap.begin(); it2 != invitedusrmap.end(); ) {
            if (it2->second == fd) {
    ...
    for (std::map<std::string, Channel>::iterator it2 = channels.begin(); it2 != channels.end(); ++it2) {
        ...
        for (std::map<std::string, int>::iterator it3 = operatorsmap.begin(); it3 != operatorsmap.end(); ) {
            if (it3->second == fd) {
